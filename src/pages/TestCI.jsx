...
const preguntas = [
  ...
  { 
    q: "Si todos los bloops son razzies y todos los razzies son lazzies, ¿los bloops son lazzies?", 
    options: ["Sí", "No"],
    className: "long"
  },
...
export default function TestCI() {
  ...
  // 🔥 Popunder solo 1 vez por sesión
  const abrirPopunder = () => {
    if (sessionStorage.getItem("popCI")) return;
    ...
    sessionStorage.setItem("popCI", "true");
  };
